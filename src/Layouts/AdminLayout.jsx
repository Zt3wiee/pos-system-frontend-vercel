...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-200 dark:bg-zinc-950 overflow-hidden">
      {/* Sidebar */}
      <>
        {sidebarOpen && (
          <div
        ...
        <aside
          className={` fixed md:static top-0 left-0 z-40  h-full w-64 bg-slate-900 text-gray-100 flex flex-col transform transition-transform duration-300
      ...
      <main className="flex-1 flex flex-col overflow-hidden md:ml-0">
        {/* Top Header */}
        <header className="h-16 bg-white dark:bg-zinc-900 border-b border-gray-200 flex items-center justify-between px-4 md:px-8 ">
          {/* Left: Page Title */}
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Avatar/Initials */}
            <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-slate-800 flex items-center justify-center text-white  font-bold shadow-sm">
